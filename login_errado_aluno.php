      ...
      <div class="login-wrap">
        ...
        <?php
              ...
              if($tent > 0){
                ...
                <a href='login-aluno.php'><button class='btn btn-primary btn-lg btn-block' type='button'>Tentar Novamente</button></a>";
              }
              else
              {
                echo "<p style='color: black;'>Suas chances acabaram, por favor aguarde 30 minutos para tentar novamente.</p><br><br>
                <a href='login-aluno.php'><button class='btn btn-primary btn-lg btn-block' type='button'>Voltar Para O Site</button></a>";
              }      
        ?>
      </div>
    </form>
