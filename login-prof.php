...
<head>
  ...
  <title>Oficina do Aluno - Login Professor</title>
  <!-- Bootstrap CSS -->
  ...
  <div s class="container">
    <form style="margin-top: 120px" class="login-form" action="check_prof.php" method="POST">
      <div class="login-wrap">
        ...
        <h3 style="margin-top: -5px;" align="center">Login Professor</h3><br>
          ...
          <?php
              if(isset($_COOKIE['tent_prof'])){
                  if($_COOKIE['tent_prof'] == 0){
                      ...
                      echo "<input type='text' name='user' class='form-control' placeholder='Usuário' required>";
                  }
              }else{
        ...
        <label class="checkbox">
          <span style="margin-left: -20px" class="pull-left"> <a href="index.php"> Página do Administrador</a></span>
          <span class="pull-right"> <a href="esqueci-senha.html"> Esqueceu a senha?</a></span>
        </label>
        <?php
              if(isset($_COOKIE['tent_prof'])){
                  if($_COOKIE['tent_prof'] == 0){
