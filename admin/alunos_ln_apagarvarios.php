...
if ($_POST['restaurar']) {
    ...
    if ($resultado_id) {
        ...
        if($resultado_id2){
            ...
            $resultado_id3=mysqli_query($link, "SELECT * FROM `sisoda_pagamentos_off` WHERE `sisoda_pagamentos_idAluno`='$value'");
            ...
            $resultado_id6=mysqli_query($link, "SELECT * FROM `sisoda_mensalidades_off` WHERE `sisoda_mensalidades_idAluno`='$value'");
            ...
            $resultado_id9=mysqli_query($link, "SELECT * FROM `sisoda_mensalidades_off` WHERE `sisoda_mensalidades_idAluno`='$value'");
