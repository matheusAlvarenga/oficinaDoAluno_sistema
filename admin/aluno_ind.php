                  ...
                  <div style='height: 44%;' class='row'>
                    ...
                    <div style='overflow-x: hidden;overflow-y: scroll; height: 78%;'>
                      ...
                      <div class='row'>
                        ...
                        $resultado_id6=mysqli_query($link,"SELECT * FROM `sisoda_aulas` WHERE `sisoda_aulas_idAluno`='$id' ORDER BY `sisoda_aulas_id` DESC");
                        ...
                        if ($resultado_id6) {
                          ...
                          while($dados_login6 = mysqli_fetch_array($resultado_id6, MYSQLI_ASSOC)){
                            ...
                            echo "<div class='row' style='border-bottom: 1px lightgrey solid; margin-bottom: 10px; padding-left: 20px;'>
                                    <p>Valor R$".$dados_login6['sisoda_aulas_valorAluno']."</p>
                                    <p>$pagamento</p>
                        ...
                        if ($resultado_id5) {
                          ...
                          while($dados_login5 = mysqli_fetch_array($resultado_id5, MYSQLI_ASSOC)){
                            ...
                            if($dados_login5['sisoda_pagamentos_obs']==NULL or $dados_login5['sisoda_pagamentos_obs']==''){
                                
                                $obs="Nenhuma Obs";
                                
                            }else{
                                
                                $obs=$dados_login5['sisoda_pagamentos_obs'];
