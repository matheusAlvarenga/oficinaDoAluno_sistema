                ...
                <form style="margin-left: -30px; margin-right: 20px;" class="form-horizontal" method="POST" action="cadastro_professor2.php">
                  <div class="form-group">
                    ...
                    <div style="margin-right: -50px;" class="col-sm-4">
                      <input type="text" maxlength="50" name="nome_prof" class="form-control">
                    </div>
                    <label style="margin-left: -50px;" class="col-sm-2 control-label">Sobrenome</label>
                    <div class="col-sm-4">
                      <input type="text" maxlength="150" name="sobrenome_prof" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label">Data de Nasc.</label>
                    <div style="margin-right: -50px;" class="col-sm-2">
                      <input type="date" name="dataNascimento_prof" class="form-control">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div style="margin-right: -26px;" class="col-sm-3">
                      <input type="text" id="bairro" name="bairro_prof" maxlength="50" class="form-control">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div style="" class="col-sm-4">
                        <input id="rep1" type="text" name="cpf_prof" maxlength="200" class="form-control">
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div style="" class="col-sm-3">
                        <input id="rep1" type="text" name="tipo_prof" maxlength="200" class="form-control">
                      </div>
                      <label class="col-sm-1 control-label">Agência</label>
                      <div style="" class="col-sm-2">
                        <input id="rep1" type="text" name="ag_prof" maxlength="200" class="form-control">
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-1">
                        <select name="unidade_aluno" class="form-control m-bot15">
