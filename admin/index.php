              ...
              <div class='col-md-12 portlets'>
                <div class='panel panel-default'>
                  ...
                  <div class='panel-body text-center'>
                    <h2>É necessário atualizar as mensalidades, fazer isso agora?</h2>
                    <a href='mensalidade.php'><button style='font-size:20px;' class='btn btn-primary'>Atualizar</button></a>
                  </div>
                </div>
              </div>
            </div>";
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
      ...
      <?php
        ...
        $sql="SELECT * FROM `sisoda_aulas` WHERE `sisoda_aulas_data` > '$hoje'";
              ...
              while($dados_login = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
                ...
                if ($resultado_id2) {
                  ...
                  while($dados_login2 = mysqli_fetch_array($resultado_id2, MYSQLI_ASSOC)){
                    ...
                    if($dados_login['sisoda_aulas_dataFinal']!=NULL and $dados_login['sisoda_aulas_dataFinal']!=''){
                        
                        $dato=date_create($dados_login['sisoda_aulas_dataFinal']);
