        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Professores</li>
              <li><i class="icon_document_alt"></i>Adicionar Pagamento de Professores</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                <h3 align="center">Adicionar Pagamento Professor</h3><br>
                <form action="adicionar_pag_prof2.php" method="GET">
