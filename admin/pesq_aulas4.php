        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Pesquisa de Aulas</li>
            </ol>
          </div>
        </div>
        <div class="row">
            ...
            <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    ...
                    <th width='13%'><i class="icon_cogs"></i> Ações</th>
                  </tr>
                  <?php 
          ...
          echo "
                    ...
                    <td>
                      <div class='btn-group'>
                        ...
                        <a class='btn btn-success'  href='editar_aula.php?id=".$dados_login['sisoda_aulas_id']."'><i class='icon_pencil-edit'></i></a>
                        <a class='btn btn-danger'  href='apagar_aula.php?id=".$dados_login['sisoda_aulas_id']."'><i class='icon_close_alt2'></i></a>
                      </div>
                    </td>
