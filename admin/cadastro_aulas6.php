<?php
	...
	// ADICIONAR AULA NA TABELA
        ...
        $sql="INSERT INTO `sisoda_aulas`(`sisoda_aulas_idAluno`, `sisoda_aulas_idProfessor`, `sisoda_aulas_data`, `sisoda_aulas_materia`, `sisoda_aulas_topicos`, `sisoda_aulas_unidade`, `sisoda_aulas_paga`, `sisoda_aulas_recebida`, `sisoda_aulas_valorProfessor`, `sisoda_aulas_valorAluno`,`sisoda_aulas_dataFinal`) VALUES ('$id_aluno','$id_prof','$data','$materias2','$topicos','$unid','0','0','$valor_prof','$valor_aluno','$data2')";
    ...
    // ATUALIZAR O SALDO
        ...
        $resultado_id5 = mysqli_query($link,"SELECT SUM(`sisoda_pagamentos_prof_valor`) FROM `sisoda_pagamentos_prof` WHERE `sisoda_pagamentos_prof_idProfessor`='$id_prof'");
                ...
                if ($resultado_id8) {
                    echo "<script>alert('Aula cadastrada com sucesso.'); window.location.href='index.php'</script>";
                }
?>