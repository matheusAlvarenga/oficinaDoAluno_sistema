...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <form action="aulas_ln_apagarvarias.php" method="POST">
  ...
  require_once('../db.class.php');
    ...
    $sql = "SELECT * FROM sisoda_aulas_off WHERE sisoda_aulas_idProfessor='$id'";
    $objDb = new db();
        ...
        while($dados_login = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
          ...
          if ($resultado_id2) {
            while($dados_login2 = mysqli_fetch_array($resultado_id2, MYSQLI_ASSOC)){
              ...
              <td><input type='checkbox' name='aluno_selec[]' value='".$dados_login['sisoda_aulas_id']."'></td>
          ...
          echo "
                    ...
                    <td>
                      <div class='btn-group'>
                        <a data-placement='bottom' data-original-title='Ver Mais' class='btn btn-primary tooltips' href='aula_ind.php?id=".$dados_login['sisoda_aulas_id']."'><i class='icon_zoom-in_alt'></i></a>
                        <a data-placement='bottom' data-original-title='Restaurar' class='btn btn-success tooltips'  href='aulas_ln_restaurar.php?id=".$dados_login['sisoda_aulas_id']."'><i class='arrow_triangle-up_alt2'></i></a>
                        <a onclick=\"javascript: return confirm('Você tem certeza?');\" data-placement='bottom' data-original-title='Apagar' class='btn btn-danger tooltips'  href='aulas_ln_apagar.php?id=".$dados_login['sisoda_aulas_id']."'><i class='icon_close_alt2'></i></a>
                      </div>
                    </td>
