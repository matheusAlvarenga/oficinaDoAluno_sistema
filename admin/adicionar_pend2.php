        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Adicionar Pendência</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                ...
                <form action="adicionar_pend3.php" method="POST">
          ...
          if($resultado_id){
            ...
            while($dados_login = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
              ...
              echo "<tr style='background-color:#dcdcdc;'>
                        <td><input type='radio' name='aluno_selec' value='".$dados_login['sisOda_alunos_id']."'></td>";
...
?>
                ...
                <div class="form-group">
                  <div class="row">
                    <label style="text-align: center; margin-top: 5px;" class="col-sm-2 control-label">Valor</label>
                    <label style="text-align: center; margin-top: 5px;" class="col-sm-10 control-label">Motivo da Pendência</label>
                  </div>
                    
                  <div class="row">
                    <div class="col-sm-2">
                      <input type="text" id="aulas" name="valor_aluno" class="form-control">
                    </div>
                    <div class="col-sm-10">
                      <input type="text" name="comen_aluno" id="valor" class="form-control">
                    </div>
                  </div>
                  <div class="row">
                  <div class="form-group">
                    <div class="col-sm-12">
                      <input type="submit" style="margin-top: 15px;" class="form-control btn btn-primary" value="ADICIONAR PENDÊNCIAS">
                    </div>
                  </div>
                  </div>
                  </div>
