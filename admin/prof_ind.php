                  ...
                  while($dados_login5 = mysqli_fetch_array($resultado_id5, MYSQLI_ASSOC)){
                    ...
                    echo "
                        ...
                        <div class='row' style='border-bottom: 1px lightgrey solid; margin-bottom: 10px; padding-left: -20px;'>
                                    <p>Valor R$".$dados_login5['sisoda_aulas_valorProfessor']."</p>
                                    <p>$paga</p>
              ...
              <?php
                ...
                if ($resultado_id7) {
                  ...
                  while($dados_login7 = mysqli_fetch_array($resultado_id7, MYSQLI_ASSOC)){
                    ...
                    if($dados_login7['sisoda_pagamentos_prof_obs']==NULL or $dados_login7['sisoda_pagamentos_prof_obs']==''){
                                
                                $obs="Nenhuma Obs";
                                
                            }else{
                                
                                $obs=$dados_login7['sisoda_pagamentos_prof_obs'];
                  ...
                  <div class='modal-dialog'>
                    <div class='modal-content'>
                      ...
                      <div class='modal-body text-center'>
                        ...
                        <img src=<?php echo "'img/prof/$foto'"; ?>>
