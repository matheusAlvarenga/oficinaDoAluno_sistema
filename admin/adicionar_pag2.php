          ...
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                ...
                <form action="adicionar_pag3.php" method="POST">
      ...
      if($resultado_id){
        ...
        while($dados_login = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
          ...
          echo "<tr style='background-color:#dcdcdc;'>
                    <td><input type='radio' name='aluno_selec' value='".$dados_login['sisOda_alunos_id']."'><input type='hidden' name='valor_aula' id='".$dados_login['sisOda_alunos_id']."' value='".$dados_login['sisOda_alunos_tipoDePlano']."'></td>";
...
?>
                ...
                <div class="form-group">
                  <div class="row">
                    <label style="text-align: center; margin-top: 5px;" class="col-sm-5 control-label">Nº de Aulas</label>
                    <label style="text-align: center; margin-top: 5px;" class="col-sm-2 control-label"></label>
                    <label style="text-align: center; margin-top: 5px;" class="col-sm-5 control-label">Valor em Dinheiro</label>
                  </div>
                  ...
                  <div class='row'>
                      ...
                      <label style="text-align: center; margin-top: 5px;" class="col-sm-12 control-label">Observação</label>
