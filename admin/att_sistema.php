	...
	// SALDOS
  		...
  		if ($query_prof) {
  			...
  			while($prof = mysqli_fetch_array($query_prof, MYSQLI_ASSOC)){
  				...
  				$id_aluno=$prof['sisoda_professores_id'];
                ...
                echo "UPDATE `sisoda_professores` SET `sisoda_professores_saldo`='$saldo_final_prof' WHERE `sisoda_professores_id`='$id_aluno'";
