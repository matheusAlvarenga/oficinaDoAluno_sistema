        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Alunos NL</li>
              <li><i class="icon_document_alt"></i>Pesquisa de Alunos NL</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                <h3 align="center">Pesquisa de Alunos Não Listados</h3><br>
                <form action="alunos_ln_apagarvarios.php" method="POST">
            ...
            echo "
                    ...
                    <td>
                      <div class='btn-group'>
                        ...
                        <a data-placement='bottom' data-original-title='Restaurar' class='btn btn-success tooltips'  href='alunos_ln_restaurar.php?id=".$dados_login['sisOda_alunos_id']."'><i class='arrow_triangle-up_alt2'></i></a>
                        <a onclick=\"javascript: return confirm('Você tem certeza?');\" data-placement='bottom' data-original-title='Apagar' class='btn btn-danger tooltips'  href='alunos_ln_apagar.php?id=".$dados_login['sisOda_alunos_id']."'><i class='icon_close_alt2'></i></a>
                      </div>
                    </td>
                  </tr>";
