...
<body>
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-book"></i>Matérias</li>
              <li><i class="fa fa-book-open"></i>Alterar Matéria</li>
            </ol>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                <h3 align="center">Alterar Matéria</h3><br>
                <table class="table table-striped table-advance table-hover">
                <tbody>
                  <form id='form' name='form' method='get' action='editar_materia2.php'>
                    <tr>
                      <th width="8%"><i class="icon_profile"></i> Id</th>
                      <th width="44%"><i class="icon_calendar"></i> Nome</th>
                      <th width="40%"><i class="icon_mail_alt"></i> Novo Nome</th>
  ...
  require_once('../db.class.php');
    ...
    $sql = "SELECT * FROM sisoda_materias WHERE sisoda_materias_id='$id'";
    ...
    $resultado_id = mysqli_query($link, $sql);
      ...
      if($resultado_id){
        ...
        while($dados_login = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)){
          ...
          $sql2="SELECT COUNT(*) FROM sisoda_professores WHERE `sisoda_professores_tipoConta` LIKE '%".$dados_login['sisoda_materias_id']."%'
";
          ...
          echo "<td align='center'>".$dados_login['sisoda_materias_id']."</td><input type='hidden' name=id value='".$dados_login['sisoda_materias_id']."'>";
            echo "
                    
                    <td>".$dados_login['sisoda_materias_nome']."</td>
                    <td><input name='nome' form='form' class='form-control' type='text'></td>
