...
<body class="login-img3-body">
  <div s class="container">
    <form style="margin-top: 120px" class="login-form" action="check_aluno.php" method="POST">
      <div class="login-wrap">
        <p class="login-img"><i class="icon_lock_alt"></i></p>
        <h3 style="margin-top: -5px;" align="center">Login Aluno</h3><br>
        <div class="input-group">
          <span class="input-group-addon"><i class="icon_mail_alt"></i></span>
          <?php
              if(isset($_COOKIE['tent_aluno'])){
                  if($_COOKIE['tent_aluno'] == 0){
                      echo "<input type='text' name='user' class='form-control' placeholder='E-mail' disabled>";
                  }
                  else{
                      echo "<input type='text' name='user' class='form-control' placeholder='E-mail' required>";
                  }
              }else{
              echo "<input type='text' name='user' class='form-control' placeholder='E-mail'>";
            }
          ?>
        </div>
        <div class="input-group">
        ...
        <label class="checkbox">
          <span class="pull-right"> <a href="esqueci-senha_aluno.html"> Esqueceu a senha?</a></span>
        </label>
        <?php
              if(isset($_COOKIE['tent_aluno'])){
                  if($_COOKIE['tent_aluno'] == 0){
