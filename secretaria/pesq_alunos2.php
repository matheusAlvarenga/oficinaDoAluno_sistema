...
<body>
  ...
  if ($nome == NULL and $tel == NULL and $data == NULL and $email == NULL) {
    ...
    $sql = "SELECT * FROM `sisoda_alunos` WHERE `sisOda_alunos_nome` LIKE '%$nome%' OR `sisoda_alunos_sobrenome`LIKE '%$nome%' AND `sisoda_alunos_email` LIKE '%$email%' AND `sisOda_alunos_dataNascimento` LIKE '%$data%' AND `sisoda_alunos_telefone` LIKE '%$tel%' ORDER BY `sisOda_alunos_id` ASC
";
