...
<body>
          ...
          <div class="col-lg-12">
            <section style="margin-top: -17px;" class="panel">
              <div class="panel-body">
                ...
                <form action="prof_ln_apagarvarios.php" method="POST">
  ...
  if ($nome == NULL and $cpf == NULL and $data == NULL and $email == NULL) {
    ...
    $sql = "SELECT * FROM `sisoda_professores_off` WHERE `sisoda_professores_nome` LIKE '%$nome%' AND `sisoda_professores_email` LIKE '%$email%' AND `sisoda_professores_data` LIKE '%$data%' AND `sisoda_professores_cpf` LIKE '%$cpf%' ORDER BY `sisoda_professores_id` ASC
";
          ...
          echo "<td>".$dados_login['sisoda_professores_nome']." ".$dados_login['sisoda_professores_sobrenome']."</td>";
            ...
            echo "
                    ...
                    <td>".$celular."</td>
                     <td>
                      <div class='btn-group'>
                        <a data-placement='bottom' data-original-title='Ver Mais' class='btn btn-primary tooltips' href='aluno_ind.php?id=".$dados_login['sisoda_professores_id']."'><i class='icon_zoom-in_alt'></i></a>
                        <a data-placement='bottom' data-original-title='Restaurar' class='btn btn-success tooltips'  href='prof_ln_restaurar.php?id=".$dados_login['sisoda_professores_id']."'><i class='arrow_triangle-up_alt2'></i></a>
                        <a onclick=\"javascript: return confirm('Você tem certeza?');\" data-placement='bottom' data-original-title='Apagar' class='btn btn-danger tooltips'  href='prof_ln_apagar.php?id=".$dados_login['sisoda_professores_id']."'><i class='icon_close_alt2'></i></a>
                      </div>
                    </td>
                  </tr>";
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="row">
                    <label style="text-align: center; margin-top: 5px; font-size: 20px;" class="col-sm-12 control-label">Restaurar Todos Os Selecionados</label>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-12">
                      <input onclick="javascript: return confirm('Você tem certeza?');" name="restaurar" type="submit" style="margin-top: 15px;" class="form-control btn btn-primary" value="CONFIRMAR">
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="row">
                    <label style="text-align: center; margin-top: 5px; font-size: 20px;" class="col-sm-12 control-label">Apagar Todos Os Selecionados</label>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-12">
                      <input onclick="javascript: return confirm('Você tem certeza?');" name="apagar" type="submit" style="margin-top: 15px;" class="form-control btn btn-primary" value="CONFIRMAR">
                    </div>
                  </div>
