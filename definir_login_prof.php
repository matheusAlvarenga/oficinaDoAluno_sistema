...
<body class="login-img3-body">
  <div s class="container">
    <form onsubmit="return validateMyForm();" style="margin-top: 90px" class="login-form" action="definir_login_prof2.php" method="POST">
      <div class="login-wrap">
        ...
        <div>
          ...
          $id=$_GET['id']; 
          $qaluno=mysqli_query($link, "SELECT `sisoda_professores_nome` FROM `sisoda_professores` WHERE `sisoda_professores_id`='$id'");

          while($aluno = mysqli_fetch_array($qaluno, MYSQLI_ASSOC)){

            $nome=$aluno['sisoda_professores_nome'];
        ...
        <div class="input-group">
          ...
          <input type='text' onkeyup='check();' name='user' class='form-control' placeholder='Usuário' required>
        </div>
        <div class="input-group">
